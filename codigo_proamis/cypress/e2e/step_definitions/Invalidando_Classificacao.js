...
//CT01: Invalidando Classificação
...
Quando('escolher o cadastro e clicar no botão ANALISAR CADASTRO CT01', () => {
...
Quando('escolher a opção DESCLASSIFICADO CT01', () => {
  cy.get(cla.botaoDesclassificado).click();
  cy.get(cla.inputJustificativaDaDesclassificação).type('Teste automatizado para a desclassificação');
}); 

Quando('clicar no botão SALVAR CT01', () => {
